    ...
    sections: [
      {
        ...
        questions: [
          { questionText: "找住处时,你常用的网站或 App 有哪些?", questionType: "open_ended", probeLevel: "standard", probeInstruction: "确认是否提到具体平台名", options: [] },
          { questionText: "订住宿时最让你抓狂的是什么?", questionType: "open_ended", probeLevel: "deep", probeInstruction: "追问具体场景与情绪", options: [] },
          { questionText: "更偏好哪类住宿?", questionType: "single_choice", probeLevel: "standard", probeInstruction: "", options: ["酒店", "民宿", "公寓"] },
        ],
      },
      {
        title: "Airbnb 任务",
        objective: "观察真实搜索过程",
        questions: [
          { questionText: "假设要去巴黎住一周,演示一下你会怎么搜?", questionType: "open_ended", probeLevel: "deep", probeInstruction: "观察流程,不打断", options: [] },
          { questionText: "完成这个任务的难易程度?", questionType: "rating", probeLevel: "standard", probeInstruction: "请其解释打分原因", options: [] },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        objective: "捕捉第一步的困惑",
        questions: [
          { questionText: "第一次打开时,你的第一感觉是什么?", questionType: "open_ended", probeLevel: "standard", probeInstruction: "", options: [] },
        ],
      },
    ],
  },
