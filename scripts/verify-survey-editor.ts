  ...
  sections: [
    {
      ...
      objective: "整体习惯",
      questions: [
        { questionText: "常用的订房网站?", questionType: "open_ended", probeLevel: "standard", probeInstruction: "", options: [] },
        { questionText: "更常用哪个平台?", questionType: "single_choice", probeLevel: "deep", probeInstruction: "追问原因", options: ["Airbnb", "Booking"] },
      ],
    },
    {
      title: "深入",
      objective: "细节",
      questions: [
        { questionText: "最抓狂的事?", questionType: "open_ended", probeLevel: "standard", probeInstruction: "", options: [] },
      ],
    },
  ],
};
