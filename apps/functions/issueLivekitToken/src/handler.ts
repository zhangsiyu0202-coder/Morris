...
/** Re-exported from registry so existing consumers don't churn imports. */
export const TOKEN_TTL_SECONDS = TIME_LIMITS.jwtTokenTtlSeconds; // Req 3.6: <= 30 min
...
export const RECLAIM_GRACE_SECONDS = TIME_LIMITS.reclaimGraceSeconds;
