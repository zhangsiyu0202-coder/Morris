...
import { hardCeilingFor, TIME_LIMITS, type PlanKeyValue } from "@merism/contracts";
import type { CreateWorkspaceDeps } from "./handler.js";

const DB_ID = "merism";
const TRIAL_MS = TIME_LIMITS.workspaceTrialMs; // 14-day Pro/Plus trial (prd-pricing.md)
