...
const DEFAULT_MAX_BYTES = SIZE_LIMITS.geminiUploadMaxBytes; // 2 GB (Gemini Files API limit)
const DEFAULT_UPLOAD_MAX_WAIT_SEC = 300;
const DEFAULT_SEGMENT_PARALLELISM = COUNT_LIMITS.geminiVisualSegmentParallelism;
