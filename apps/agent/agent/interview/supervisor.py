    ...
    class InterviewSupervisorAgent(Agent):
        ...
        async def _finish_session(self, started_monotonic: float, *, state: str) -> None:
            ...
            if self._repo is None:
                return
            recording = await self._persist_recording()
            ...
            self._repo.finalize_session(
                ...
                transcript_segments=(
                    ...
                    if self._transcript is not None and not self._transcript.is_empty
                    else []
                ),
                recording=recording,
        ...
        async def _persist_recording(self) -> dict[str, Any] | None:
            ...
            if owner_user_id is None:
                ...
                return None
            return self._repo.save_recording(
                self._state.sessionId,
