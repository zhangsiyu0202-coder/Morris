...
/**
 * Researcher login keeps the primary credential fields together. An email-code
 * fallback remains available without making password login a two-step flow.
 */
export function LoginForm({
  ...
  return (
    <>
      <AuthHeading title="欢迎回来" subtitle="登录您的 Merism 研究工作台" />
