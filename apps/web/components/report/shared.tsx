...
// NOTE: This is the AnalysisReport-embedded insight item (auto-generated
// from sessions during analysis rollup), NOT the researcher-authored Notebook
// collection (renamed in the notebooks sub-spec). The two are intentionally
// separate (ADR-0003 D2, AGENTS.md "Optimize technology" rule). Kept named
// `Insight` only for the AnalysisReport-internal alias.
