  ...
  return (
    <header className="flex flex-col gap-5">
      <div className="flex flex-wrap items-end justify-between gap-3">
        ...
        <button
          type="button"
          className="inline-flex items-center gap-1.5 rounded bg-ink-900 px-3.5 py-2 text-body-sm font-medium text-mauve-50 shadow-sm transition-colors hover:bg-ink-800"
        >
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 rounded bg-mauve-50 px-4 py-3 shadow-[0_2px_4px_rgba(167,133,133,0.08)]">
        ...
        <button
          type="button"
          className="inline-flex items-center gap-1.5 rounded bg-ink-0 px-3 py-1.5 text-body-sm font-medium text-ink-700 shadow-[inset_0_0_0_1px_var(--color-mauve-300)] transition-colors hover:bg-mauve-100"
        >
