...
function BigKpi({ value, label }: { value: string; label: string }) {
  return (
    <div className="flex flex-col gap-1 rounded-lg border border-mauve-200 bg-ink-0 px-5 py-5">
...
export function SummarySection({ report }: { report: SurveyReport }) {
  ...
  return (
    <section className="flex flex-col gap-4">
      ...
      <div className="rounded-lg border border-mauve-200 bg-ink-0 px-5 py-4">
