...
function BigKpi({ value, label }: { value: string; label: string }) {
  return (
    <div className="flex flex-col gap-1 rounded-lg bg-mauve-200 px-5 py-5 shadow-[0_2px_4px_rgba(167,133,133,0.08)]">
...
export function SummarySection({ report }: { report: SurveyReport }) {
  ...
  return (
    <section className="flex flex-col gap-4">
      ...
      <div className="rounded-lg bg-mauve-200 px-5 py-4 shadow-[0_2px_4px_rgba(167,133,133,0.08)]">
