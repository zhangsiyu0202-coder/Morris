...
function ChartFrame({ caption, children }: { caption: string; children: React.ReactNode }) {
  return (
    <div className="flex flex-col gap-3 rounded bg-mauve-100 p-4">
...
function QuestionCard({ stat, index }: { stat: QuestionStat; index: number }) {
  ...
  return (
    <article className="overflow-hidden rounded bg-mauve-50 shadow-[0_2px_4px_rgba(167,133,133,0.08)]">
      <button
        type="button"
        ...
        <div className="grid gap-5 px-5 py-5 shadow-[inset_0_1px_0_var(--color-mauve-300)] lg:grid-cols-2">
          ...
          <div className="flex flex-col">
            {stat.kind === "choice" ? (
              ...
              <div className="flex h-full flex-col justify-center gap-2 rounded bg-mauve-100 p-4">
