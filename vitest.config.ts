...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@merism/contracts": path.resolve(__dirname, "packages/contracts/src/index.ts"),
      "@merism/observability": path.resolve(__dirname, "packages/observability/src/index.ts"),
